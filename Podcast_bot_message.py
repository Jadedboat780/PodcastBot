...
ВАЖНЫЕ УТОЧНЕНИЯ!
1) Бот делит аудио на части по 60 минут. Это сделано, чтобы обойти ограничения telegram без потерь качества звука
2) Аудио файлы хранятся в расширении opus
3) Бот не способен обрабатывать стримы
6) При возникновении ошибки, бот будет отправлять одно из нескольких заготовленных сообщений
7) Если есть замечания или предложения по улучшению бота, то можете написать мне в личку: @Tokin_Nikita''',
