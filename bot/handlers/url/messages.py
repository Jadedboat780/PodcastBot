...
error_messages: dict[str, str] = {
	"url_wrong": "Неправильный URL",
	"url_to_stream": "Нельзя отправлять ссылки на прямые трансляции",
	"large_file": "Извините, но из-за ограничений Bot API нельзя отправлять файлы больше 50мб, поэтому держите ссылку на нужный файл: ",
