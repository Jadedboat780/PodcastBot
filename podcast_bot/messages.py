...
base_anecdote: dict[int: str] = {
    ...
    31: 'Приходит еврей в овощной магазин. И видит на стене объявление: "ЕВРЕЯМ КВАШЕННУЮ КАПУСТУ НЕ ПРОДАВАТЬ!!!". Он возмущенно входит в кабинет к директору и с должным акцентом кричит:\n— Что за безобгазие, это дискгиминация! Я буду жаговаться!\nДиректор магазина невозмутимо поднимает на него глаза и говорит:\n— Что ты огешь, ты ее пгобывал?'
}

url_error: dict[int: str] = {
    1: 'Неправильный URL',
    2: 'Нельзя отправлять ссылки на прямые трансляции',
    3: 'Извините, но что-то пошло не так.\nПопробуйте отправить ссылку на другое видео',
}
